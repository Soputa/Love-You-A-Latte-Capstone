...
?>
    ...
    if(isset($_POST['btnedit'])){
      ...
      $select = $pdo->prepare("select * from sir_inventory where id=".$_POST['btnedit'] );
...
<p><input type="number" id="iId" name="inventory_id" value="'.$row->id.'"></p>
<p><input type="text" id="desc" name="item_description" value="'.$row->desc.'"></p>
<p><input type="number" step="0.01" id="price" name="price" value="'.$row->price.'"></p>
<p><input type="url"id="link" name="image_link" placeholder="https://drive.google.com/drive/folders/1FzcoeK_PwqGCGqmL7OdlxBTIv8Ieqbp6?usp=sharing " value="'.$row->image.'"></p>
...
';
      ...
      echo'<p><input type="number" id="iId" name="inventory_id" value="'.$row->id.'"></p>
      <p><input type="text" id="desc" name="item_description" value="'.$row->desc.'"></p>
      <p><input type="number" step="0.01" id="price" name="price" value="'.$row->price.'"></p>
      <p><input type="url"id="link" name="image_link" placeholder="https://drive.google.com/drive/folders/1FzcoeK_PwqGCGqmL7OdlxBTIv8Ieqbp6?usp=sharing " value="'.$row->image.'"></p>
